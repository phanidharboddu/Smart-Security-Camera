...
class Video:
    def __init__(self):
        ...
        self.bs = bs.Bs()
        self.persons = person.Persons(self.settings.movementMaximum, self.settings.movementMinimum,
    ...
    def testSettings(self):
        ...
        if key == ord("8"):
            ...
            print
            "dilationPixels: ", self.settings.dilationPixels
        if key == ord("7"):
            self.settings.dilationPixels -= 1
            print
            "dilationPixels: ", self.settings.dilationPixels
        if key == ord("6"):
            ...
            print
            "thresholdLimit: ", self.settings.thresholdLimit
        if key == ord("5"):
            self.settings.thresholdLimit -= 1
            print
            "thresholdLimit: ", self.settings.thresholdLimit
        if key == ord("4"):
            ...
            print
            "movementMaximum: ", self.settings.movementMaximum
        if key == ord("3"):
            self.settings.movementMaximum -= 1
            print
            "movementMaximum: ", self.settings.movementMaximum
        if key == ord("2"):
            ...
            print
            "movementMinimum: ", self.settings.movementMinimum
        if key == ord("1"):
            self.settings.movementMinimum -= 1
            print
            "movementMinimum: ", self.settings.movementMinimum
        ...
        if key == ord("+"):
            ...
            print
            "movementTime: ", self.settings.movementTime
        if key == ord("p"):
            self.settings.movementTime -= 1
            print
            "movementTime : ", self.settings.movementTime
    ...
    def compare(self):
        ...
        for contour in contours:
            ...
            cv2.putText(self.frame, "{}".format(cv2.contourArea(contour)), (x, y + h + 20), cv2.FONT_HERSHEY_SIMPLEX,
                        0.7, color, 1)
            cv2.putText(self.frame, "{} : {}".format(person.id, person.lastmoveTime), (x, y + 20),
        ...
        if self.settings.debug:
            ...
            cv2.putText(self.frame, "Status: {}".format(detectStatus), (10, 20), cv2.FONT_HERSHEY_SIMPLEX, 0.8,
                        (0, 140, 255), 1)
